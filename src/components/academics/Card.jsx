...
const Card = ({ title, subTitle, result, des }) => {
  return (
    <div className="w-full h-fit flex group">
      ...
      <div className="w-full bg-black bg-opacity-20 border border-gray-700 rounded-lg py-6 px-8 lgl:px-10 flex flex-col justify-center shadow-shadowOne relative">
